...
class LauncherWindow(QMainWindow):
    ...
    def launch_master(self):
        ...
        self.fade_out_and_launch("MasterNode.py")

    def launch_worker(self):
        """Launch Worker Node with exit animation"""
        self.fade_out_and_launch("WorkerNode.py")

    def fade_out_and_launch(self, script_name):
        """Fade out window and launch target script"""
        self.opacity_effect = QGraphicsOpacityEffect()
        self.setGraphicsEffect(self.opacity_effect)
        self.fade_anim = QPropertyAnimation(self.opacity_effect, b"opacity")
        self.fade_anim.setDuration(300)
        ...
        self.fade_anim.finished.connect(lambda: self.launch_script(script_name))
        self.fade_anim.start()

    def launch_script(self, script_name):
        """Launch the target script and close launcher"""
        try:
